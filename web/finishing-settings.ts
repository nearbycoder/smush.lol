...
export const hasPixelEffects = (fields: Record<string, string>) => Number(fields.contrast ?? 100) !== 100 || Number(fields.exposure || 0) !== 0 || Boolean(fields.colorFilter && fields.colorFilter !== "none" && Number(fields.filterAmount ?? 100) > 0);

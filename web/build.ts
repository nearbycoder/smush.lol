...
const result = await Bun.build({ entrypoints: ["web/index.html", "web/docs.html", "web/pixel-worker.ts", "web/codec-worker.ts", "web/background-worker.ts"], outdir: "public", target: "browser", minify: true, splitting: true });

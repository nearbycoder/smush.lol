...
test("pixel-art resizing persists and forces browser resampling",()=>{const fields=savedSettings({pixelArt:"true"},true).fields;expect(fields.pixelArt).toBe("true");expect(usesBrowser(null,fields)).toBe(true);});
